...
-- and mustfa ve ali derse ismi mustafa ve ali olaný siler isim de mustafa ve ali gecmeli
...
/* ======================== DELETE - TRUCATE - DROP ============================
    ...
    /* 2-) DELETE komutu beraberinde WHERE cümleciði kullanýlabilir. TRUNCATE ile kullanýlmaz.
